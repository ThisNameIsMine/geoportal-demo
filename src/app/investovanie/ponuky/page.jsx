  ...
  return (
    <div className="bg-gray-200 min-h-screen px-4">
      <div className="container mx-auto py-10">
        <h1 className="text-primary font-bold text-4xl md:text-5xl text-center">
          Možnosti <span className="text-secondary uppercase">práve</span> pre
          vás
        </h1>

        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-10 max-w-[1000px] mx-auto">
        ...
        <div className="flex justify-center py-4 pt-8">
          <button className="bg-tertiary text-white font-bold text-lg md:text-xl py-4 w-full md:w-1/2 rounded-lg hover:scale-105 transition-transform">
